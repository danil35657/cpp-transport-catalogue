...
struct MapRendererSettings {
    ...
    MapRendererSettings(double width, double height, double padding, double line_width, double stop_radius, int bus_label_font_size, svg::Point bus_label_offset, int stop_label_font_size, svg::Point stop_label_offset, svg::Color underlayer_color, double underlayer_width, std::vector<svg::Color> color_palette) : width_(width), height_(height), padding_(padding), line_width_(line_width), stop_radius_(stop_radius), bus_label_font_size_(bus_label_font_size), bus_label_offset_(bus_label_offset), stop_label_font_size_(stop_label_font_size), stop_label_offset_(stop_label_offset), underlayer_color_(underlayer_color), underlayer_width_(underlayer_width), color_palette_(color_palette) {
    }
...
public:
    ...
    void SetSettings(const MapRendererSettings& settings);
